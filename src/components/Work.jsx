  ...
  return (
    <>
      <section id="work" className="py-10 px-12 max-w-[1200px] mx-auto max-md:px-6">
        <div className="section-label font-mono text-[9px] tracking-[4px] text-accent uppercase mb-12 flex items-center gap-4 after:content-[''] after:flex-1 after:h-px after:bg-border">Work & Portfolio</div>
        ...
        <div className="work-masonry reveal max-md:flex-col max-md:gap-[14px]">
          <div className="wm-col wide">
            ...
            <div className="work-card wm-placeholder group relative overflow-hidden flex flex-col justify-end p-6 aspect-video max-md:min-h-[220px]">
              <div className="work-card-img absolute inset-0 flex items-center justify-center">
